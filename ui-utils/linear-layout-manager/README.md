...
It was modified to change the anchor behavior when new items are added to the top of the list. See [#6378](https://github.com/qubesmail/qubesmail-android/pull/6379).
