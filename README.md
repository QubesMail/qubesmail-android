...
<a href="https://play.google.com/store/apps/details?id=net.qubesmail.android&referrer=utm_campaign%3Dandroid_metadata%26utm_medium%3Dweb%26utm_source%3Dgithub.com%26utm_content%3Dbadge" target="_blank"><img src="./docs/assets/get-it-on-play.png" alt="Get it on Google Play" height="28"></a>
<a href="https://f-droid.org/packages/net.qubesmail.android"><img src="./docs/assets/get-it-on-fdroid.png" alt="Get it on F-Droid" height="28"></a>
<a href="https://apps.obtainium.imranr.dev/"><img src="./docs/assets/get-it-on-obtainium.png" alt="Get it on Obtainium" height="28"></a>
[![Latest release](https://img.shields.io/github/release/qubesmail/qubesmail-android.svg?style=for-the-badge&filter=QUBESMAIL_*&logo=qubesmail)](https://github.com/qubesmail/qubesmail-android/releases/latest)
[![Latest beta release](https://img.shields.io/github/release/qubesmail/qubesmail-android.svg?include_prereleases&style=for-the-badge&label=beta&filter=QUBESMAIL_*b*&logo=qubesmail)](https://github.com/qubesmail/qubesmail-android/releases)
...
Thunderbird for Android is based on K-9 Mail, which comes with a rich history of success and functionality in open source email. We'd also like to express our deep appreciation to the Thunderbird team for their incredible work in making such a great project possible!

## Download

QubesMail for Android can be downloaded from a couple of sources:

- QubesMail on [Google Play](https://play.google.com/store/apps/details?id=net.qubesmail.android&referrer=utm_campaign%3Dandroid_metadata%26utm_medium%3Dweb%26utm_source%3Dgithub.com%26utm_content%3Dlink) or [F-Droid](https://f-droid.org/packages/net.qubesmail.android)
- QubesMail Beta on [Google Play](https://play.google.com/store/apps/details?id=net.qubesmail.android.beta&referrer=utm_campaign%3Dandroid_metadata%26utm_medium%3Dweb%26utm_source%3Dgithub.com%26utm_content%3Dlink) or [F-Droid](https://f-droid.org/packages/net.qubesmail.android.beta)
- [Github Releases](https://github.com/qubesmail/qubesmail-android/releases)
- [FFUpdater](https://f-droid.org/packages/de.marmaro.krt.ffupdater/) allows installing the latest versions from ftp.mozilla.org
- [Obtainium](https://obtainium.imranr.dev/): Use "Filter release title by regular expression" under "Additional options" with `QubesMail`. More info in [Complex Obtainium Apps list](https://apps.obtainium.imranr.dev/).

By using QubesMail for Android Beta, you have early access to current development and are able to try new features earlier.

Check out the [Release Notes](https://github.com/qubesmail/qubesmail-android/releases) to find out what changed in each version of QubesMail for Android.
...
as the foundation for QubesMail on Android. Since then, we’ve been updating both apps to give
