...
This is a command line interface that will check the [weblate](https://hosted.weblate.org/projects/qubesmail/qubesmail-android/#languages) translation state for all languages and print out the ones that are above a certain threshold.
