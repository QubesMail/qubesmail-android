...
The Compose design system is named [**Bolt**](https://bolt.qubesmail.net/) and lives in the local `components/`
included build while we exercise Gradle isolated/composite build behavior. QubesMail for Android consumes only the
